...
// Database helper class for managing expenses data
class ExpensesDatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    // Upgrade the database (drop and recreate table) if the schema version changes
    ...
    // Retrieve all expenses data from the database
    ...
    // Delete expenses data from the database by ID
